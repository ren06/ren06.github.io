    ...
    class ReadError extends HTMLElement {
        ...
        constructor() {
            ...
            document.addEventListener("DOMNodeInserted", function(e) {
                if(e.target.startsWith('<label id="sap-fpa-ui-splash-view-message-label" data-sap-ui="sap-fpa-ui-splash-view-message-label" style="direction:inherit;text-align:left" class="logon-message-label sapUiLbl sapUiLblNowrap">')){
